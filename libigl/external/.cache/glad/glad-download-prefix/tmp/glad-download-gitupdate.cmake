...
execute_process(
  COMMAND "/usr/local/bin/git" show-ref 09b4969c56779f7ddf8e6176ec1873184aec890f
  WORKING_DIRECTORY "/Users/huxuechun/code/mycode/possion_reconstruction/libigl/cmake/../external/glad"
...
# yet).
execute_process(
  COMMAND "/usr/local/bin/git" rev-list --max-count=1 09b4969c56779f7ddf8e6176ec1873184aec890f
  WORKING_DIRECTORY "/Users/huxuechun/code/mycode/possion_reconstruction/libigl/cmake/../external/glad"
  RESULT_VARIABLE error_code
...
if(error_code OR is_remote_ref OR NOT ("${tag_sha}" STREQUAL "${head_sha}"))
  ...
  if(is_remote_ref)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/Users/huxuechun/code/mycode/possion_reconstruction/libigl/cmake/../external/glad/'.\nYou will have to resolve the conflicts manually")
    endif()
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: '/Users/huxuechun/code/mycode/possion_reconstruction/libigl/cmake/../external/glad/'.\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
  else()
    execute_process(
      COMMAND "/usr/local/bin/git" checkout 09b4969c56779f7ddf8e6176ec1873184aec890f
      WORKING_DIRECTORY "/Users/huxuechun/code/mycode/possion_reconstruction/libigl/cmake/../external/glad"
      RESULT_VARIABLE error_code
      )
    if(error_code)
