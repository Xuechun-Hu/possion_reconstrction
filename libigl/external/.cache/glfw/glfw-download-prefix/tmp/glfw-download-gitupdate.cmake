...
execute_process(
  COMMAND "/usr/bin/git" show-ref "3.3"
  WORKING_DIRECTORY "/Users/huxuechun/Documents/my_code/possion_reconstrction/libigl/cmake/../external/glfw"
    ...
    if("REBASE" STREQUAL "CHECKOUT")
      ...
      if(error_code)
        ...
        if(NOT "REBASE" STREQUAL "REBASE_CHECKOUT")
          ...
          message(FATAL_ERROR "\nFailed to rebase in: '/Users/huxuechun/Documents/my_code/possion_reconstrction/libigl/cmake/../external/glfw'."
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: '/Users/huxuechun/Documents/my_code/possion_reconstrction/libigl/cmake/../external/glfw'."
                              "\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
